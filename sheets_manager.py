...
HEADERS = ["التاريخ", "نوع الوارد", "اسم المورد", "اسم المنتج", "الحالة", "ملاحظات"]
...
class SheetsManager:
    ...
    def append_record(self, date_str, incoming_type, supplier, product, status, notes):
        row = [date_str, incoming_type, supplier, product, status, notes]
